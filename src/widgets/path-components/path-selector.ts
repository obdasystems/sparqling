...
import { OntologyPath, EntityTypeEnum, Entity } from "../../api/swagger";
import { ColoursNames, GrapholscapeTheme, TypesEnum, incrementalGraphStyle, ui } from 'grapholscape'

export default class PathSelector extends ui.ModalMixin(ui.BaseMixin(LitElement)) {
