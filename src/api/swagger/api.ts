...
export const QueryGraphBGPApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        putQueryGraphAnnotation: async (graphElementId: string, sourceClassIRI: string, predicateIRI: string, queryGraph: QueryGraph, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'graphElementId' is not null or undefined
...
export const QueryGraphBGPApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async putQueryGraphAnnotation(graphElementId: string, sourceClassIRI: string, predicateIRI: string, queryGraph: QueryGraph, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueryGraph>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.putQueryGraphAnnotation(graphElementId, sourceClassIRI, predicateIRI, queryGraph, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This call is used when the user click on a highlighted class and should add a triple pattern of the form like `?x rdf:type <targetClassIRI>`. The server should find `?x` in the SPARQL code as the variable associated to the `sourceClassIRI`.
...
export const QueryGraphBGPApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        putQueryGraphAnnotation(graphElementId: string, sourceClassIRI: string, predicateIRI: string, queryGraph: QueryGraph, options?: any): AxiosPromise<QueryGraph> {
...
export class QueryGraphBGPApi extends BaseAPI {
     ...
     * @memberof QueryGraphBGPApi
     */
    public putQueryGraphAnnotation(graphElementId: string, sourceClassIRI: string, predicateIRI: string, queryGraph: QueryGraph, options?: AxiosRequestConfig) {
...
export const QueryGraphExtraApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        countStarQueryGraph: async (active: boolean, queryGraph: QueryGraph, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const QueryGraphExtraApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async countStarQueryGraph(active: boolean, queryGraph: QueryGraph, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueryGraph>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.countStarQueryGraph(active, queryGraph, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * The distinct value is defined in the query graph in the request body.
...
export const QueryGraphExtraApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        countStarQueryGraph(active: boolean, queryGraph: QueryGraph, options?: any): AxiosPromise<QueryGraph> {
            return localVarFp.countStarQueryGraph(active, queryGraph, options).then((request) => request(axios, basePath));
        },
        /**
         * The distinct value is defined in the query graph in the request body.
         * @summary Set the distinct value.
...
export class QueryGraphExtraApi extends BaseAPI {
     ...
     */
    public countStarQueryGraph(active: boolean, queryGraph: QueryGraph, options?: AxiosRequestConfig) {
